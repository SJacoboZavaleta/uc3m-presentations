...
## [Estado del Arte]{.monash-blue} {.title-slide2 auto-animate=true}
...
`r noa(w = "200px", flip = TRUE, other = 'data-id="noa"')`  `r kuka(w = "280px", other = 'data-id="kuka"')`  `r boston(w = "200px", other = 'data-id="boston"' )` `r ur(w = "300px", other = 'data-id="ur"' )` `r atlas(w = "200px", other = 'data-id="atlas"')`
